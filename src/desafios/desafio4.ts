...
let elementQuery = document.querySelector('#search') as HTMLInputElement;
let elementPassword = document.getElementById('senha') as HTMLInputElement;
let elementUserName = document.getElementById('login') as HTMLInputElement;
let elementApyKey = document.getElementById('api-key') as HTMLInputElement;
...
class HttpClient {
  static async get({url, method, body = null} : HttpGet) {
