...
var elementQuery = document.querySelector('#search');
var elementPassword = document.getElementById('senha');
var elementUserName = document.getElementById('login');
var elementApyKey = document.getElementById('api-key');
